...
public class InsertChange
    ...
    private ChangeTypeEnum type = ChangeTypeEnum.INSERT;
    private String textChanges;
    private int startPosition;
    private int cursorPositionBefore;
    private int cursorPositionAfter;

    public InsertChange(int startPosition, String textChanges, int cursorPositionBefore, int cursorPositionAfter) {
    ...
    public boolean equals(Object obj) {
        ...
        final InsertChange other = (InsertChange) obj;
